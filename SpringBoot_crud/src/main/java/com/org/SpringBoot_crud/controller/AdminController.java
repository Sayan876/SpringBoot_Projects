...
import com.org.SpringBoot_crud.server.AdminService;
...
public class AdminController {
	...
	public ResponseEntity<ResponseStructure<Admin>> findbyPhone(@RequestParam long phone, @RequestParam String password) {
